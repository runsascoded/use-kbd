...
function useActionsRegistry(options = {}) {
  ...
  const [modeCustomizations, setModeCustomizationsRaw] = useState(() => {
  ...
  const setModeCustomizations = useCallback((update) => {
    setModeCustomizationsRaw((prev) => {
      const next = typeof update === "function" ? update(prev) : update;
      if (storageKey && typeof window !== "undefined") {
        try {
          const key = `${storageKey}-modes`;
          const isEmpty = Object.keys(next.additions).length === 0 && Object.keys(next.removals).length === 0 && Object.keys(next.userModes).length === 0;
          if (isEmpty) {
  ...
  const getEffectiveMode = useCallback((actionId) => {
    for (const [modeId, actionIds] of Object.entries(modeCustomizations.removals)) {
      if (actionIds.includes(actionId)) return void 0;
    }
  ...
  const addActionToMode = useCallback((actionId, modeId) => {
    const action = actionsRef.current.get(actionId);
    ...
    const actionIds = groupId ? Array.from(actionsRef.current.entries()).filter(([, a]) => a.config.arrowGroup?.groupId === groupId).map(([id]) => id) : pairId ? Array.from(actionsRef.current.entries()).filter(([, a]) => a.config.actionPair?.pairId === pairId).map(([id]) => id) : tripletId ? Array.from(actionsRef.current.entries()).filter(([, a]) => a.config.actionTriplet?.tripletId === tripletId).map(([id]) => id) : [actionId];
  ...
  const removeActionFromMode = useCallback((actionId, modeId) => {
    const action = actionsRef.current.get(actionId);
    const groupId = action?.config.arrowGroup?.groupId;
    const pairId = action?.config.actionPair?.pairId;
    const tripletId = action?.config.actionTriplet?.tripletId;
  ...
  const exportBindings = useCallback(() => {
    const hasModeCusts = Object.keys(modeCustomizations.additions).length > 0 || Object.keys(modeCustomizations.removals).length > 0 || Object.keys(modeCustomizations.userModes).length > 0;
    return {
...
function findConflicts(keymap, getEffectiveMode) {
  ...
  const anySharedScope = (aActions, bActions) => {
...
function useActionPair(id, config) {
  const {
    label,
    group,
    mode,
...
function useParamEntry({
  ...
  const startParamEntry = useCallback((action) => {
  ...
  const handleParamKeyDown = useCallback((e) => {
    if (e.key === "Enter") {
      e.preventDefault();
      if (paramValue) {
        submitParam();
...
function ArrowsMove({ className, style }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      className,
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("polyline", { points: "18 9 21 12 18 15" }),
        /* @__PURE__ */ jsx("polyline", { points: "6 9 3 12 6 15" }),
        /* @__PURE__ */ jsx("line", { x1: "12", y1: "3", x2: "12", y2: "21" }),
        /* @__PURE__ */ jsx("polyline", { points: "9 6 12 3 15 6" }),
        /* @__PURE__ */ jsx("polyline", { points: "9 18 12 21 15 18" })
      ]
    }
  );
}
function ArrowsDpad({ className, style }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      className,
      ...
      stroke: "none",
      children: [
        /* @__PURE__ */ jsx("polygon", { points: "12,2 8,9 16,9" }),
        /* @__PURE__ */ jsx("polygon", { points: "12,22 8,15 16,15" }),
        /* @__PURE__ */ jsx("polygon", { points: "2,12 9,8 9,16" }),
        /* @__PURE__ */ jsx("polygon", { points: "22,12 15,8 15,16" })
      ]
    }
  );
}
function ArrowsDouble({ className, style }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      className,
...
function LookupModal({ defaultBinding = "meta+shift+k" } = {}) {
  ...
  const handleParamSubmit = useCallback((actionId, captures) => {
    closeLookup();
  ...
  const extractDigitsFromPending = useCallback(() => {
    let digitStr = "";
  ...
  const attemptExecute = useCallback((result) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "kbd-lookup-backdrop", onClick: handleBackdropClick, children: /* @__PURE__ */ jsxs("div", { className: "kbd-lookup", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs("div", { className: "kbd-lookup-header", children: [
      /* @__PURE__ */ jsxs("div", { className: "kbd-lookup-search", children: [
        renderedPendingKeys && /* @__PURE__ */ jsx("span", { className: "kbd-lookup-pending", children: renderedPendingKeys }),
        /* @__PURE__ */ jsx(
          "input",
          {
            ref: inputRef,
    ...
    paramEntry.isEnteringParam ? /* @__PURE__ */ jsxs("div", { className: "kbd-lookup-param", children: [
      /* @__PURE__ */ jsx("div", { className: "kbd-lookup-param-label", children: paramEntry.pendingAction?.label }),
      /* @__PURE__ */ jsx(
        "input",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "kbd-lookup-param-hint", children: "\u21B5 confirm \xB7 Esc cancel" })
    ] }) : (
      /* Results list */
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { d: "M6 8h.01M10 8h.01M14 8h.01M18 8h.01M6 12h.01M10 12h.01M14 12h.01M18 12h.01M8 16h8" })
      ]
    }
  );
}
function SpeedDial({
  ...
  if (showShortcuts) {
    builtinActions.push({
      key: "_kbd_shortcuts",
      label: "Shortcuts",
      icon: /* @__PURE__ */ jsx(KeyboardIcon, {}),
...
function Omnibar({
  ...
  const localSentinelRef = useRef(null);
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsx("div", { className: backdropClassName, onClick: handleBackdropClick, children: /* @__PURE__ */ jsxs("div", { className: omnibarClassName, role: "dialog", "aria-modal": "true", "aria-label": "Command palette", children: [
    /* @__PURE__ */ jsxs("div", { className: "kbd-omnibar-header", children: [
      pendingParamAction ? (
        ...
        /* @__PURE__ */ jsxs("div", { className: "kbd-omnibar-param-entry", children: [
          /* @__PURE__ */ jsx("span", { className: "kbd-omnibar-param-label", children: paramEntry.pendingAction?.label ?? results.find((r) => r.id === pendingParamAction)?.action.label ?? pendingParamAction }),
          /* @__PURE__ */ jsx(
            "input",
            {
              ref: paramEntry.paramInputRef,
    ...
    /* @__PURE__ */ jsx("div", { className: "kbd-omnibar-results", ref: resultsContainerRef, children: totalResults === 0 && !isLoadingRemote ? /* @__PURE__ */ jsx("div", { className: "kbd-omnibar-no-results", children: query ? "No matching commands" : "Start typing to search commands..." }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      hasMoreLocal && /* @__PURE__ */ jsx(
        "div",
        {
          ref: localSentinelRef,
          className: "kbd-omnibar-pagination",
          children: /* @__PURE__ */ jsxs("span", { className: "kbd-omnibar-pagination-info", children: [
...
function organizeShortcuts(keymap, labels, descriptions, groupNames, groupOrder, actionRegistry, showUnbound = true, modesMap, activeMode, getEffectiveMode, registeredActions) {
  const actionBindings = getActionBindings(keymap);
  ...
  const getSortKey = (entry) => {
    const actionId = entry.type === "action" ? entry.actionId : entry.type === "arrowGroup" ? entry.actionIds.left : entry.actionIds[0];
  ...
  if (actionRegistry) {
    ...
    for (const group of groupMap.values()) {
      ...
      for (const entry of group.shortcuts) {
        ...
        if (!pairs.has(ap.pairId)) {
          pairs.set(ap.pairId, { entries: [], indices: /* @__PURE__ */ new Set() });
        }
        const p = pairs.get(ap.pairId);
        p.entries.push(entry);
        p.indices.add(ap.index);
      }
      const toRemovePair = /* @__PURE__ */ new Set();
      const toInsertPair = [];
    ...
    for (const group of groupMap.values()) {
      const triplets = /* @__PURE__ */ new Map();
      for (const entry of group.shortcuts) {
        if (entry.type !== "action") continue;
        const at = actionRegistry[entry.actionId]?.actionTriplet;
        if (!at) continue;
        if (!triplets.has(at.tripletId)) {
          triplets.set(at.tripletId, { entries: [], indices: /* @__PURE__ */ new Set() });
        }
        const t = triplets.get(at.tripletId);
        t.entries.push(entry);
        t.indices.add(at.index);
      }
      const toRemoveTriplet = /* @__PURE__ */ new Set();
      const toInsertTriplet = [];
...
function ArrowGroupRow({
  ...
  const renderArrows = () => {
    if (ArrowIconComponent) {
      return /* @__PURE__ */ jsx(ArrowIconComponent, { className: "kbd-key-icon kbd-arrow-group-compact" });
    }
    return /* @__PURE__ */ jsx("span", { className: "kbd-arrow-group-arrows", children: DIRECTION_ORDER.map((dir) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "kbd-action kbd-arrow-group-row", "data-arrow-group": entry.groupId, children: [
    ...
    /* @__PURE__ */ jsxs("span", { className: "kbd-action-bindings", children: [
      ...
      hasExtras && DIRECTION_ORDER.map((dir) => {
        ...
        return /* @__PURE__ */ jsx(Fragment$1, { children: renderExtraBindings(entry.actionIds[dir], extras) }, dir);
      })
    ] })
  ] });
}
function ActionPairRow({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "kbd-action kbd-action-pair-row", "data-action-pair": entry.pairId, children: [
    entry.description ? /* @__PURE__ */ jsx(Tooltip, { title: entry.description, children: /* @__PURE__ */ jsx("span", { className: "kbd-action-label", children: entry.label }) }) : /* @__PURE__ */ jsx("span", { className: "kbd-action-label", children: entry.label }),
    /* @__PURE__ */ jsxs("span", { className: "kbd-action-bindings", children: [
      renderCell(entry.actionIds[0], entry.bindings[0]),
      /* @__PURE__ */ jsx("span", { className: "kbd-action-pair-sep", children: "/" }),
...
function ActionTripletRow({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "kbd-action kbd-action-triplet-row", "data-action-triplet": entry.tripletId, children: [
    entry.description ? /* @__PURE__ */ jsx(Tooltip, { title: entry.description, children: /* @__PURE__ */ jsx("span", { className: "kbd-action-label", children: entry.label }) }) : /* @__PURE__ */ jsx("span", { className: "kbd-action-label", children: entry.label }),
    /* @__PURE__ */ jsxs("span", { className: "kbd-action-bindings", children: [
      renderCell(entry.actionIds[0], entry.bindings[0]),
      /* @__PURE__ */ jsx("span", { className: "kbd-action-pair-sep", children: "/" }),
...
function ModesSection({ modeGroups, editable, registry, actionRegistry, renderShortcutEntry }) {
  const [addingToMode, setAddingToMode] = useState(null);
  ...
  const globalActions = useMemo(() => {
    return Object.entries(actionRegistry).filter(([id, action]) => {
  ...
  const addAction = useCallback((actionId, modeId) => {
    addActionToMode(actionId, modeId);
    setAddingToMode(null);
    setSearchQuery("");
    setSelectedIndex(-1);
  }, [addActionToMode]);
  return /* @__PURE__ */ jsxs("div", { className: "kbd-modes-section", children: [
    /* @__PURE__ */ jsx("h3", { className: "kbd-modes-title", children: "Modes" }),
    modeGroups.map((group) => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "kbd-modes-header", children: [
              /* @__PURE__ */ jsx("span", { className: "kbd-modes-label", style: mode.color ? { color: mode.color } : void 0, children: group.name }),
              mode.activationBindings.map((binding) => /* @__PURE__ */ jsx("kbd", { className: "kbd-kbd kbd-modes-binding", children: parseKeySeq(binding).map((elem, i) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
                i > 0 && /* @__PURE__ */ jsx("span", { className: "kbd-sequence-sep", children: " " }),
                /* @__PURE__ */ jsx(SeqElemDisplay2, { elem })
              ] }, i)) }, binding)),
              mode.color && /* @__PURE__ */ jsx("span", { className: "kbd-modes-color", style: { backgroundColor: mode.color } })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "kbd-modes-shortcuts", children: [
              group.shortcuts.map((entry) => {
                ...
                return /* @__PURE__ */ jsxs("div", { className: "kbd-modes-action-row", children: [
              ...
              group.shortcuts.length === 0 && /* @__PURE__ */ jsx("div", { className: "kbd-modes-empty", children: "No actions" })
            ] }),
            editable && (addingToMode === mode.id ? /* @__PURE__ */ jsxs("div", { className: "kbd-modes-add-panel", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  ref: searchInputRef,
              ...
              /* @__PURE__ */ jsxs("ul", { className: "kbd-modes-search-results", children: [
                filteredGlobalActions.slice(0, 8).map((action, i) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
                  "button",
                  {
                ...
                filteredGlobalActions.length === 0 && /* @__PURE__ */ jsx("li", { className: "kbd-modes-no-results", children: "No global actions found" })
              ] })
            ] }) : /* @__PURE__ */ jsx(
              "button",
              {
...
function ShortcutsModal({
  ...
  const ctx = useMaybeHotkeysContext();
  const ArrowIconComponent = useMemo(() => {
  ...
  const hasCustomizations = ctx ? Object.keys(ctx.registry.overrides).length > 0 || Object.keys(ctx.registry.removedDefaults).length > 0 || modeCusts && (Object.keys(modeCusts.additions).length > 0 || Object.keys(modeCusts.removals).length > 0 || Object.keys(modeCusts.userModes).length > 0) : false;
  ...
  const [addAfterKey, setAddAfterKey] = useState(null);
  const [pendingConflict, setPendingConflict] = useState(null);
  const [hasPendingConflictState, setHasPendingConflictState] = useState(false);
  const [arrowGroupEditState, setArrowGroupEditState] = useState(null);
  const [arrowGroupActiveKeys, setArrowGroupActiveKeys] = useState(null);
  const arrowGroupEditRef = useRef(null);
  const editingActionRef = useRef(null);
  const editingKeyRef = useRef(null);
  const addingActionRef = useRef(null);
  const addAfterKeyRef = useRef(null);
  ...
  const startArrowGroupEditing = useCallback((groupId) => {
    ...
    (actionId, key, showRemove = false) => {
      ...
      return /* @__PURE__ */ jsx(
        BindingDisplay2,
        {
          ...
          onAdd: editable && multipleBindings ? () => startAddingAfter(actionId, key) : void 0,
          pendingKeys,
          activeKeys,
  ...
  const renderCell = useCallback(
    (actionId, keys) => {
      ...
      return /* @__PURE__ */ jsxs("span", { className: "kbd-action-bindings", children: [
        keys.map((key) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
          renderEditableKbd(actionId, key, true),
          isAddingThis && addAfterKey === key && /* @__PURE__ */ jsx(
            BindingDisplay2,
            {
              binding: "",
              isEditing: true,
        ...
        isAddingThis && addAfterKey === null && /* @__PURE__ */ jsx(
          BindingDisplay2,
          {
            binding: "",
            isEditing: true,
  ...
  const renderShortcutEntry = (entry) => {
    if (entry.type === "arrowGroup") {
      return /* @__PURE__ */ jsx(
        ArrowGroupRow,
        {
          ...
          renderExtraBindings: (actionId2, bindings2) => /* @__PURE__ */ jsx(Fragment, { children: bindings2.map((key) => renderEditableKbd(actionId2, key, true)) }),
          arrowGroupEditState,
          arrowGroupActiveKeys,
          conflicts,
          ArrowIconComponent
    ...
    return /* @__PURE__ */ jsxs("div", { className: "kbd-action", children: [
      description ? /* @__PURE__ */ jsx(TooltipComponentProp, { title: description, children: /* @__PURE__ */ jsx("span", { className: "kbd-action-label", children: label }) }) : /* @__PURE__ */ jsx("span", { className: "kbd-action-label", children: label }),
  ...
  return /* @__PURE__ */ jsx(TooltipContext.Provider, { value: TooltipComponentProp, children: /* @__PURE__ */ jsx("div", { className: backdropClassName, onClick: handleBackdropClick, children: /* @__PURE__ */ jsxs("div", { ref: modalRef, className: modalClassName, role: "dialog", "aria-modal": "true", "aria-label": "Keyboard shortcuts", tabIndex: -1, onClick: handleModalClick, children: [
    ...
    shortcutGroups.filter((g) => !g.mode).map((group) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "kbd-group",
        children: [
