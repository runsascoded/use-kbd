...
declare const FLOAT_PLACEHOLDER = "__FLOAT__";
/**
...
declare function SpeedDial({ actions, showShortcuts, position, longPressDuration, primaryIcon, ariaLabel, className, chevronMode, TooltipRenderer, }: SpeedDialProps): react_jsx_runtime.JSX.Element | null;
